...
public class Main_shopping extends javax.swing.JFrame {
    ...
    private void testData() {
        ...
        int ID = 1;
          ArrayList<SanPham> dsSP= SanPhamDAO.LayDanhSachSanPham();
                 for (SanPham sp:dsSP)
                 {
                      home.addItem(new ModelItem(ID++, sp.getTenSP(),sp.getMaNhaCungCap(),Double.parseDouble(sp.getGiaSP()),
                              sp.getMaLoai(), new ImageIcon(getClass().getResource("/com/raven/image/"+sp.getAnhSP()))));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_shopping.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Main_shopping().setVisible(true);
            }
        });
    }
